...
try:
    ...
    raise ImportError("Install requirements-deep.txt to diagnose Phase 4") from exc


def main() -> None:
    parser = argparse.ArgumentParser(description="Diagnose Transformer transfer")
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "artifacts/experiments/cnn_transformer_seed42/generalization_diagnosis.json"
        ),
    )
